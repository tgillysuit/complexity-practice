...
public class Main {
  ...
  // O(1) For the containsKey and get operations.
  ...
  // HashMap, because of constant number reports. O(1) time complexity
  ...
  // What would be a good choice of data structure?
  // LinkedList, because we can replace a song with a certain index or add to the playlist,
  // or put the song at the end/beginning of the list. O(n) time complexity
  ...
  // What would be a good choice of data structure?
  // LinkedList, because we can add and remove to the lists more sufficient and quickly. O(n) time complexity
}